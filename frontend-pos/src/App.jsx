            ...
            {lastBilledInvoice && (
              ...
              <div className="p-3 bg-indigo-50 border border-indigo-200 rounded-xl flex justify-between items-center text-xs">
                ...
                <div>
                  ...
                  <span className="text-[9px] uppercase tracking-wider text-indigo-500 font-black block">Last Billed</span>
                      ...
                      {recentInvoices.map(inv => (
                        ...
                        <div key={inv.id} className="p-2.5 bg-slate-50 border border-slate-200 rounded-lg flex justify-between items-center text-xs">
                          ...
                          <div className="flex-1">
                            ...
                            <span className="text-[9px] text-slate-400 font-bold">Total: ₹{(inv.grandTotal / 100).toFixed(2)}</span>
                          ...
                          <button
                            ...
                            className="p-1 hover:bg-slate-200 border border-slate-355 rounded text-slate-650"
            ...
            <div id="receipt-print-area" className="space-y-4 font-mono text-xs">
              ...
              <table className="w-full text-[10px]">
                ...
                <tbody>
                  ...
                  {invoiceResponse.invoiceItems?.map((it, idx) => (
